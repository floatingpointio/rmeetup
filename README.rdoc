...
A simple Ruby gem to access the Meetup API v2
...
[Zishan Ahmad](https://github.com/zishan/rmeetup) - refactored for completeness, and modeled after [github_api](https://github.com/peter-murach/github)
